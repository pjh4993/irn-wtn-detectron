...
# ---------------------------------------------------------------------------- #
# CLASSIFIER_ML options
# ---------------------------------------------------------------------------- #
_C.MODEL.CLASSIFIER_ML = CN()
# This is the number of foreground classes.
_C.MODEL.CLASSIFIER_ML.NUM_CLASSES = 80

_C.MODEL.CLASSIFIER_ML.IN_FEATURES = ["res5"]
_C.MODEL.CLASSIFIER_ML.PRIOR_PROB = 0.01

# Loss parameters
_C.MODEL.CLASSIFIER_ML.FOCAL_LOSS_GAMMA = 2.0
_C.MODEL.CLASSIFIER_ML.FOCAL_LOSS_ALPHA = 0.25

# One of BN, SyncBN, FrozenBN, GN
# Only supports GN until unshared norm is implemented
_C.MODEL.CLASSIFIER_ML.NORM = ""
